...
public class RideHistoryServiceTest {
    ...
    @Test
    void testGetClientRideHistory_WithoutFilters() {
        ...
        Page<RideHistoryDto> result = rideHistoryService.getClientRideHistory(clientUuid, null, 0, 10, "createdAt,desc");
        ...
        assertThat(capturedUrl).startsWith(serverRidesUrl + "/client/" + clientUuid + "/history");
    ...
    @Test
    void testGetClientRideHistory_WithFilters() {
        // Przygotowanie danych testowych
        ...
        // Wykonanie metody testowanej
        Page<RideHistoryDto> result = rideHistoryService.getClientRideHistory(clientUuid, filterDto, 0, 10, "createdAt,desc");
        ...
        // Sprawdzenie parametrów dat w URL bez szczegółowego formatowania
